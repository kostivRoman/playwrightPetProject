...
export class RegForm {
  ...
  constructor(protected page: Page, formElements: UserRegistrationForm) {
    ...
    this.phoneCodeSelector = formElements.phoneNumber ? this.page.locator("#sv-phoneCode-select") : undefined;
    ...
    this.countrySelect = formElements.country ? this.page.locator('#sv-countryCode-select') : undefined;
    this.countryItem = formElements.country ? this.page.locator(".sv-item--wrap") : undefined;
    //this.page.locator("#countryOption");


    this.promoCodeInput = formElements.promoCodeText ? this.page.locator("#registrationPromoCode") : undefined



    this.currencySelect = formElements.currency ? this.page
      .locator("#sv-currency-select") : undefined;
